...
public class SplineUser : MonoBehaviour, ISerializationCallbackReceiver {
    ...
    public bool samplesAreLooped { get { return _loopSamples && _clipFrom >= _clipTo; } }

    public RotationModifier rotationModifier { get { return _rotationModifier; } }

    public OffsetModifier offsetModifier { get { return _offsetModifier; } }

    public ColorModifier colorModifier { get { return _colorModifier; } }

    public SizeModifier sizeModifier { get { return _sizeModifier; } }
    ...
    protected Transform trs { get { return _trs; } }
    protected bool hasTransform { get { return _hasTransform; } }
    ...
    public Vector3 EvaluatePosition(double percent) { return _sampleCollection.EvaluatePosition(UnclipPercent(percent)); }
    ...
    public double Travel(double start, float distance, Spline.Direction direction, out float moved) {
        moved = 0f;
        if (direction == Splines.Spline.Direction.Forward && start >= 1.0) {
            return 1.0;
        } else if (direction == Splines.Spline.Direction.Backward && start <= 0.0) {
            return 0.0;
        }
    ...
    public double Travel(double start, float distance, Spline.Direction direction = Splines.Spline.Direction.Forward) {
        float moved;
